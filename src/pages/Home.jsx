  ...
  return (
    <div className="home-page">
        ...
        <div className="container">
          <div className="hero-content">
            ...
            <p className="hero-subtitle">
              Your trusted partner for international education and immigration to the UK, USA, Canada, Australia, and Germany.
            </p>
      ...
      <section className="section why-us-section bg-light">
        <div className="container">
          <h2 className="section-title">Why Choose GradRoute?</h2>
          <p className="section-subtitle">We bridge the gap between local talent and global opportunities through personalized guidance.</p>
